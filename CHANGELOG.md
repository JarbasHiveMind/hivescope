...
- ci: install the plot extra by its name in the coverage job [\#75](https://github.com/JarbasHiveMind/hivescope/pull/75) ([JarbasAl](https://github.com/JarbasAl))
...
- feat: NAT-aware session assertions for the shipped session model [\#61](https://github.com/JarbasHiveMind/hivescope/pull/61) ([JarbasAl](https://github.com/JarbasAl))
...
- fix: Han audit round 3 — loopback floor isolation, ping correlation, doc corrections [\#42](https://github.com/JarbasHiveMind/hivescope/pull/42) ([JarbasAl](https://github.com/JarbasAl))
